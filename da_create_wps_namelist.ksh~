...
&share
 wrf_core = 'ARW',
 max_dom = $NL_MAX_DOM,
 start_year = $NL_START_YEAR,$NL_START_YEAR,$NL_START_YEAR,
 start_month = $NL_START_MONTH,$NL_START_MONTH,$NL_START_MONTH,
 start_day = $NL_START_DAY,$NL_START_DAY,$NL_START_DAY,
 start_hour = $NL_START_HOUR,$NL_START_HOUR,$NL_START_HOUR,
 end_year = $NL_END_YEAR,$NL_END_YEAR,$NL_END_YEAR,
 end_month = $NL_END_MONTH,$NL_END_MONTH,$NL_END_MONTH,
 end_day = $NL_END_DAY,$NL_END_DAY,$NL_END_DAY,
 end_hour = $NL_END_HOUR,$NL_END_HOUR,$NL_END_HOUR,
