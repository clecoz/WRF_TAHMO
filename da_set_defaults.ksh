...
# Time info:
export DATE=${DATE:-2008020512}                   # Current date.
export INITIAL_DATE=${INITIAL_DATE:-2008020512}   # Start date of test period
export FINAL_DATE=${FINAL_DATE:-2008020512}       # Final date of test period.
...
export GEOG_DATA_RES=${GEOG_DATA_RES:-default}
