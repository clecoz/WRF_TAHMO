...
export RUN_RESTORE_DATA_GDASBUFR=${RUN_RESTORE_DATA_GDASBUFR:-false}
...
export RELEASE=${RELEASE:-WRF}
export REGION=${REGION:-con200}
export DOMAINS=${DOMAINS:-03}                            # Domain names.
...
export REL_DIR=${REL_DIR:-$HOME/WRF}    # Directory containing codes.
#print $REL_DIR
...
export WRF_DIR=${WRF_DIR:-$REL_DIR/WRFV3}           # WRF directory.
export WRFNL_DIR=${WRFNL_DIR:-$REL_DIR/WRFV3}
export WRFPLUS_DIR=${WRFPLUS_DIR:-$REL_DIR/WRFPLUSV3} # WRF TL/ADJ directory.
...
export WPS_GEOG_DIR=${WPS_GEOG_DIR:-/run/media/aliabbasi/Data2/NWP_DATA/geog_complete/} 
export MAX_DOMAINS=${MAX_DOMAINS:-3}
export PARENT_ID01=${PARENT_ID01:-1}
export PARENT_ID02=${PARENT_ID02:-1}
export PARENT_ID03=${PARENT_ID03:-2}
export PARENT_GRID_RATIO01=${PARENT_GRID_RATIO01:-1}
export PARENT_GRID_RATIO02=${PARENT_GRID_RATIO02:-3}
export PARENT_GRID_RATIO03=${PARENT_GRID_RATIO03:-3}
export I_PARENT_START01=${I_PARENT_START01:-1}
export I_PARENT_START02=${I_PARENT_START02:-51}
export I_PARENT_START03=${I_PARENT_START03:-91}
export J_PARENT_START01=${J_PARENT_START01:-1}
export J_PARENT_START02=${J_PARENT_START02:-21}
export J_PARENT_START03=${J_PARENT_START03:-31}
export NL_E_WE01=${NL_E_WE01:-163}
export NL_E_WE02=${NL_E_WE02:-184}
export NL_E_WE03=${NL_E_WE03:-184}
export NL_E_SN01=${NL_E_SN01:-163}
export NL_E_SN02=${NL_E_SN02:-217}
export NL_E_SN03=${NL_E_SN03:-280}
export MAP_PROJ=${MAP_PROJ:-lambert}
export REF_LAT=${REF_LAT:-16.0}
export REF_LON=${REF_LON:--2.0}
export TRUELAT1=${TRUELAT1:-16.0}
export TRUELAT2=${TRUELAT2:--2.0}
export STAND_LON=${STAND_LON:--2.0}
export NL_DX=${NL_DX:-27000}
export NL_DY=${NL_DY:-27000}
export GEOG_DATA_RES01=${GEOG_DATA_RES01:-default}
export GEOG_DATA_RES02=${GEOG_DATA_RES02:-default}
export GEOG_DATA_RES03=${GEOG_DATA_RES03:-default}
